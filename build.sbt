...
sbtPlugin    := true
scalaVersion := "2.12.9" // not fully working with Scala v2.13 yet due to "Conflicting cross-version suffixes in: org.scala-lang.modules:scala-xml, org.scala-lang.modules:scala-parser-combinators, com.typesafe:ssl-config-core"
...
//// 2. dir$ docker build --force-rm --squash -t play-java-seed:2.7.r1 ./target/docker/stage
